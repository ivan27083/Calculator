...
void menu_m(){
    int k;
    bool check = true;
    cout <<"Введите 0 - для выхода, 1 - сложение матриц, 2 - вычитание, 3 - умножение, 4 - умножение матрицы на число, 5 - сложение матрицы с числом, 6 - транспонирование матрицы, 7 - обратная матрица, 8 - определитель " << endl;
    do{
        cin >> k;
